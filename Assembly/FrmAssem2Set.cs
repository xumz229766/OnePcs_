...
namespace Assembly
{
    public partial class FrmAssem2Set : Form
    {
        ...
        public void updateUI()
        {
            ...
            {
                CommonSet.WriteInfo("组装界面2更新异常:" + ex.ToString());
            }
        ...
        public void UpdateControl()
        {
                ...
                setNumerialControl(nudCamUpExpProduct, AssembleSuction2.dExposureTimeUp);
                setNumerialControl(nudCamUpGainProduct, AssembleSuction2.dGainUp);
                setNumerialControl(nudCamUpLight, AssembleSuction2.dLightUp);

                setNumerialControl(nudExpProduct, AssembleSuction2.dExposureTimeDown);
                setNumerialControl(nudGainProduct, AssembleSuction2.dGainDown);
                setNumerialControl(nudCamDownLight, AssembleSuction2.dLightDown);

                setNumerialControl(nudExpSuction, AssembleSuction2.dExposureTimeSuction);
                setNumerialControl(nudGainSuction, AssembleSuction2.dGainSuction);
                ...
                setNumerialControl(nudAssemDist1, optSuction.dPreH1);
                setNumerialControl(nudAssemDist2, optSuction.dPreH2);
                setNumerialControl(nudAssemZ1, optSuction.dAssembleH);
                ...
                //setNumerialControl(nudCheckPosX,AssembleSuction2.pCheckSuction.X -25*(iSuctionNum-1));
                ...
                if (rbtn1.Checked)
                {
                    setNumerialControl(nudCalibX, (CommonSet.dic_Assemble2[10].pAssemblePos1.X + CommonSet.dic_Assemble2[iSuctionNum].DPosCameraDownX - CommonSet.dic_Assemble2[10].DPosCameraDownX));
                    ...
                    setNumerialControl(nudCalibMakeUpX, CommonSet.dic_Assemble2[iSuctionNum].dMakeUpX);
                    setNumerialControl(nudCalibMakeUpY, CommonSet.dic_Assemble2[iSuctionNum].dMakeUpY);
                    setNumerialControl(nudCamUpPosZ, AssembleSuction2.pCamBarrelPos1.Z);
                    setNumerialControl(nudCamDownPosZ, CommonSet.dic_Assemble2[iSuctionNum].dCalibPosZ);
                }
                else
                {
                    setNumerialControl(nudCalibX, (CommonSet.dic_Assemble2[10].pAssemblePos2.X + CommonSet.dic_Assemble2[iSuctionNum].DPosCameraDownX - CommonSet.dic_Assemble2[10].DPosCameraDownX));
                    ...
                    setNumerialControl(nudCalibMakeUpX, CommonSet.dic_Assemble2[iSuctionNum].dMakeUpX2);
                    setNumerialControl(nudCalibMakeUpY, CommonSet.dic_Assemble2[iSuctionNum].dMakeUpY2);
                    setNumerialControl(nudCamUpPosZ, AssembleSuction2.pCamBarrelPos2.Z);
                    setNumerialControl(nudCamDownPosZ, CommonSet.dic_Assemble2[iSuctionNum].dCalibPosZ);
                }

                setNumerialControl( nudGainCalibCamDown, AssembleSuction2.dCalibGainDown);
                setNumerialControl(nudGainCalibCamUp, AssembleSuction2.dCalibGainUp);
        ...
        public void SaveUI()
        {
            ...
            //    return;
                ...
                AssembleSuction2.dExposureTimeUp = (double)nudCamUpExpProduct.Value;
                AssembleSuction2.dGainUp = (double)nudCamUpGainProduct.Value;
                AssembleSuction2.dLightUp = (double)nudCamUpLight.Value;

                AssembleSuction2.dExposureTimeDown = (double)nudExpProduct.Value;
                AssembleSuction2.dGainDown = (double)nudGainProduct.Value;
                AssembleSuction2.dLightDown = (double)nudCamDownLight.Value;

                AssembleSuction2.dExposureTimeSuction = (double)nudExpSuction.Value;
                AssembleSuction2.dGainSuction = (double)nudGainSuction.Value;
                ...
                if (rbtn1.Checked)
                {
                    ...
                    CommonSet.dic_Assemble2[iSuctionNum].dMakeUpX = (double)nudCalibMakeUpX.Value;
                    CommonSet.dic_Assemble2[iSuctionNum].dMakeUpY = (double)nudCalibMakeUpY.Value;
                    ...
                    CommonSet.dic_Assemble2[iSuctionNum].dCalibPosZ = (double)nudCamDownPosZ.Value;
                }
                else
                {
                    //组装平台2的标定参数
                    ...
                    CommonSet.dic_Assemble2[iSuctionNum].dMakeUpX2 = (double)nudCalibMakeUpX.Value;
                    CommonSet.dic_Assemble2[iSuctionNum].dMakeUpY2 = (double)nudCalibMakeUpY.Value;
                ...
                AssembleSuction2.dCalibGainUp = (double)nudGainCalibCamUp.Value;
                AssembleSuction2.dCalibGainDown = (double)nudGainCalibCamDown.Value;
        }
        ...
        private void btnCamUpCheck_Click(object sender, EventArgs e)
        {
            try
            {
                    ...
                    CheckUpC1(AssembleSuction2.strPicCameraUpCheckName);
        ...
        {
            //AssembleSuction2 suction = CommonSet.dic_Assemble1[iSuctionNum];
            ...
            WriteFile("D:\\中心检测数据\\工位1\\", "1," + AssembleSuction2.imgResultUp.CenterRow.ToString("0.000") + "," + AssembleSuction2.imgResultUp.CenterColumn.ToString("0.000") + ",");
            HTuple width, height;
        ...
        private void btnTriggerCamUp_MouseDown(object sender, MouseEventArgs e)
        {
            try
            {
                    ...
                    if (CommonSet.camUpC2 != null)
                    {
                        CommonSet.camUpC2.SetExposure((double)nudCamUpExposure.Value);
                        CommonSet.camUpC2.SetGain((double)nudGainCamUp.Value);
        ...
        private void btnTriggerCamDown_MouseDown(object sender, MouseEventArgs e)
        {
            try
            {
                ...
                if (CommonSet.camDownC2 != null)
                {
                    CommonSet.camDownC2.SetExposure((double)nudCamDownExposure.Value);
                    CommonSet.camDownC2.SetGain((double)nudGainCamDown.Value);
        ...
        private void btnCamDownCheck_Click(object sender, EventArgs e)
        {
            try
            {
                    ...
                    CheckDownC1(CommonSet.dic_Assemble2[iSuctionNum].strPicDownProduct);
        ...
        {
            //if ((mc.dic_Axis[AXIS.组装Z1轴].dPos > (AssembleSuction2.pSafeXYZ.Z + 0.01)) && (iStation == 1))
            //{
        ...
        private void btnCenterCheck_Click(object sender, EventArgs e)
        {
            try
            {
                    ...
                    CheckDownC1(CommonSet.dic_Assemble2[iSuctionNum].strPicDownSuctionCenterName);
        ...
        private void btnCalibSuctionCheck_Click(object sender, EventArgs e)
        {
            try
            {
                    ...
                    CheckUpC1(AssembleSuction2.strResultSuctionName);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                    ...
                    CheckUpC1(AssembleSuction2.strResultLenName);
        ...
        private void cbUseCalibDown_Click(object sender, EventArgs e)
        {
            if (cbUseCalibDown.Checked)
            {
                ...
                AssembleSuction2.dDownAng = AssembleSuction2.GetDownCameraAngle();
            }
            else
            {
        ...
        private void cbUseCalibUp_Click(object sender, EventArgs e)
        {
            if (cbUseCalibUp.Checked)
            {
                ...
                AssembleSuction2.dUpAng = AssembleSuction2.GetUpCameraAngle();
            }
            else
            {
        ...
        private void btnTriggerCamDownSuction_MouseDown(object sender, MouseEventArgs e)
        {
            try
            {
                ...
                if (CommonSet.camDownC2 != null)
                {
                    CommonSet.camDownC2.SetExposure(AssembleSuction2.dExposureTimeSuction);
                    CommonSet.camDownC2.SetGain(AssembleSuction2.dGainSuction);
                    mc.setDO(DO.组装下相机2, true);
                }
        ...
        private void btnTriggerCamUpProduct_MouseDown(object sender, MouseEventArgs e)
        {
            try
            {
                ...
                {
                    CommonSet.camUpC2.SetExposure(AssembleSuction2.dExposureTimeUp);
                    CommonSet.camUpC2.SetGain(AssembleSuction2.dExposureTimeUp);
                    mc.setDO(DO.组装上相机2, true);
                }
        ...
        private void btnGoCalibXY_Click(object sender, EventArgs e)
        {
            if (rbtn1.Checked)
            {
                ...
                mc.AbsMove(axisX, CommonSet.dic_Assemble2[iSuctionNum].pAssemblePos1.X, 50);
                mc.AbsMove(axisY, CommonSet.dic_Assemble2[iSuctionNum].pAssemblePos1.Y, 50);
            }
            else 
            {
                ...
                mc.AbsMove(axisX, CommonSet.dic_Assemble2[iSuctionNum].pAssemblePos2.X, 50);
                mc.AbsMove(axisY, CommonSet.dic_Assemble2[iSuctionNum].pAssemblePos2.Y, 50);
            }
        }
        ...
        private void btnGoMakeUp_Click(object sender, EventArgs e)
        {
            if (rbtn1.Checked)
            {
                ...
                mc.AbsMove(axisX, CommonSet.dic_Assemble2[iSuctionNum].pAssemblePos1.X + (double)nudCalibMakeUpX.Value, 50);
                mc.AbsMove(axisY, CommonSet.dic_Assemble2[iSuctionNum].pAssemblePos1.Y + (double)nudCalibMakeUpY.Value, 50);
            }
            else
            {
                if (mc.dic_Axis[axisZ].dPos > (AssembleSuction2.pSafeXYZ.Z + 0.05))
                ...
                mc.AbsMove(axisX, CommonSet.dic_Assemble2[iSuctionNum].pAssemblePos2.X + (double)nudCalibMakeUpX.Value, 50);
                mc.AbsMove(axisY, CommonSet.dic_Assemble2[iSuctionNum].pAssemblePos2.Y + (double)nudCalibMakeUpY.Value, 50);
            }
        }
        ...
        private void btnUpdatePos_Click(object sender, EventArgs e)
        {
            ...
            if (rbtn1.Checked)
            {
                nudCalibMakeUpX.Value = (decimal)((dUpx - dDownX) + CommonSet.dic_Assemble2[iSuctionNum].dMakeUpX);
                nudCalibMakeUpY.Value = (decimal)(-(dUpy - dDownY) + CommonSet.dic_Assemble2[iSuctionNum].dMakeUpY);
                CommonSet.dic_Assemble2[iSuctionNum].dMakeUpX = (double)nudCalibMakeUpX.Value;
                CommonSet.dic_Assemble2[iSuctionNum].dMakeUpY = (double)nudCalibMakeUpY.Value;
            ...
            {
                nudCalibMakeUpX.Value = (decimal)((dUpx - dDownX) + CommonSet.dic_Assemble2[iSuctionNum].dMakeUpX2);
                nudCalibMakeUpY.Value = (decimal)(-(dUpy - dDownY) + CommonSet.dic_Assemble2[iSuctionNum].dMakeUpY2);
                CommonSet.dic_Assemble2[iSuctionNum].dMakeUpX2 = (double)nudCalibMakeUpX.Value;
                CommonSet.dic_Assemble2[iSuctionNum].dMakeUpY2 = (double)nudCalibMakeUpY.Value;
        ...
        private void btnCamX_Click(object sender, EventArgs e)
        {
            ...
            mc.AbsMove(axisX, CommonSet.dic_Assemble2[iSuctionNum].DPosCameraDownX, 100);
        }
